...
_pkg_config = {
    'arch':               '',
    'default_bin_dir':    '/src/rfactor/env/bin',
    'default_mod_dir':    '/src/rfactor/env/lib/python3.9/site-packages',
    'default_sip_dir':    '/src/rfactor/env/share/sip',
    'deployment_target':  '',
    'platform':           'linux-g++',
    'py_conf_inc_dir':    '/src/rfactor/env/include/python3.9',
    'py_inc_dir':         '/src/rfactor/env/include/python3.9',
    'py_lib_dir':         '/src/rfactor/env/lib/python3.9/config',
    'py_version':         0x030900,
    'qt_framework':       0,
    'sip_bin':            '/src/rfactor/env/bin/sip',
    'sip_config_args':    '--sysroot=/src/rfactor/env',
    'sip_inc_dir':        '/src/rfactor/env/include/python3.9',
    'sip_module_dir':     '/src/rfactor/env/lib/python3.9/site-packages',
    'sip_root_dir':       '/src/rfactor/env/lib/python3.9/site-packages',
